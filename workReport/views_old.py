...
from workReport.forms import RejectForm, NeedStructForm, WorkPartForm, ReportForm
from workReport.models import WorkReport, Reject, WorkPart
from workReport.views import calculateEquipment
